...
@class MTMaterialView; @class NCNotificationShortLookView; @class PLPlatterHeaderContentView; @class NCNotificationContentView; @class NCNotificationViewControllerView; @class PLShadowView; @class UIUserInterfaceStyleArbiter; @class UIImageView; 
